                            ...
                            <div>
                                ...
                                <div >
                                    ...
                                    {featured2023.map((item, index) => {
                                        ...
                                        return (
                                            <div className="p-project" key={index} style={{margin: "3px"}}>
                    ...
                    <div className="p-modal">
                        <div className="md-card">
                            <div className="md-card-left md-card-side">
                                ...
                                <h3 className="md-card-left-title">{this.state.modalData.Owner}<br></br>
                                    {
                                        this.state.modalData.Tag == `feature` ? "" : "(Owner)"
                                    }
                                </h3>
                                <ul className="md-card-left-owner">
                                    {
                                        this.state.modalData.Tag == `feature` ? ""
                                            :
                                            <>
                            ...
                            <div className="md-card-right md-card-side">
                                <div className="md-card-right-title">
                                    ...
                                    <button type="button" onClick={() => {
                                        ...
                                        <svg xmlns="https://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 172 172" style={{ "fill": "rgba(0, 0, 0, 0.87)" }}>
                    ...
                    <div className={this.state.scrollStamp > 690 ? "p-search-section search-scrolled" : "p-search-section"}>
                        <div className="p-search">
                            <div className="p-search-input">
                                <svg xmlns="https://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 172 172" style={{ "fill": "rgba(0, 0, 0, 0.87)" }}>
                                    <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style={{ "mix-blend-mode": "normal" }}>
                                        <path d="M0,172v-172h172v172z" fill="none"></path>
                                        <g style={{ "fill": "#fff" }}>
